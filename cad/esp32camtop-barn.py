...
def sdholder():
    return trans(0, 0, h - wth + .5 - 2, ccube(25, 19, 4) - down(.5)(ccube(22.2, 17, 3)))
...
def assembly():
    ...
    return base - down(eps)(cutout1 + cutout2) + dimples - trans(d/2 - wth, 0, h - 5.2, plughole()) - trans(0, 0, h+wth, cutter) - trans(0, 0, -5, cutter) + ridges - ledhole() + sdholder()
...
# Local Variables:
# compile-command: "python esp32camtop-barn.py"
# End:
